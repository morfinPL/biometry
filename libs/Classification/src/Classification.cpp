...
Classification::NNClassifier::NNClassifier(const std::vector<int>& trainY, const std::vector<std::vector<int>>& trainFeatures)
    : trainY(trainY), trainFeatures(trainFeatures)
{
}
