...
std::vector<int> classify(const int N, const double& frequencyResolution, const std::vector<std::vector<double>>& queries,
                          const std::map<int, std::vector<std::vector<double>>>& train)
{
...
std::pair<std::vector<std::vector<double>>, std::map<int, std::vector<std::vector<double>>>> dataPartition(
    const int id, const std::vector<AudioFile<double>>& data1, const std::vector<AudioFile<double>>& data2,
    const std::vector<AudioFile<double>>& data3)
{
...
void printHelp(const std::map<std::string, std::string>& params)
{
